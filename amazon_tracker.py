...
class AmazonAPI:
    ...
    def run(self):
        ...
        print(f"{len(links)} links to products found...")
        print("Getting info about the product")
    ...
    def get_products_links(self):
        ...
        time.sleep(2)  #wait time to load page
    ...
    def get_title(self):
        try:
            ...
            print(e)
            print(f"Could not find title of a product - {self.driver.current_url}")
            return None
    ...
    def get_seller(self):
        try:
            ...
            print(e)
            print(f"Could not find seller of a product - {self.driver.current_url}")
            return None
    ...
    def get_price(self):
        ...
        try:
            ...
            try:
                ...
                print(e)
                print(f"Could not find price of a product - {self.driver.current_url}")
                return None
        except Exception as e:
            print(e)
            print(f"Could not find price of a product - {self.driver.current_url}")
...
if __name__ == '__main__':
    ...
    results = amazon.run()
    GenerateReport(NAME, FILTERS, BASE_URL, CURRENCY, results)
